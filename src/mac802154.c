...
const mac_mib_t mac_default_MIB = {
    ...
    .macACLEntryDescriptorSet         = {defaultACLEntry_M, defaultACLEntry_M, defaultACLEntry_M, defaultACLEntry_M,
                                         defaultACLEntry_M, defaultACLEntry_M, defaultACLEntry_M, defaultACLEntry_M,
                                         defaultACLEntry_M, defaultACLEntry_M},
        ...
        case mac_mlme_scan_confirm: {
            ...
            switch(primitive->MLME_SCAN_confirm.ScanType) {
                ...
                case mac_passive_scan: {
                    ...
                    assert(primitive->MLME_SCAN_confirm.ResultListSize <=
                           sizeof(primitive->MLME_SCAN_confirm.PANDescriptorList) / sizeof(mac_pan_descriptor_t));
                ...
                case mac_energy_detect_scan:
                    memcpy(primitive->MLME_SCAN_confirm.EnergyDetectList,
                        buffer + 8, primitive->MLME_SCAN_confirm.ResultListSize);
                    break;
